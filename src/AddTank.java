...
public class AddTank extends JFrame{
	...
	public AddTank() {
		...
		setContentPane(new JLabel(new ImageIcon("C:\\Users\\Uchchhwash\\workspace\\Vapor Clouds\\Images\\AddTank.jpg")));
		Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
		this.setLocation(dim.width/2-this.getSize().width/2, dim.height/2-this.getSize().height/2);
	    setResizable(false);
		setTitle("Add Tanks");
		
		JLabel lblMod = new JLabel("TANK");
		...
		JLabel lblBatteryLife = new JLabel("Coil Qty");
		...
		lblPrice.setBounds(117, 286, 97, 42);
		getContentPane().add(lblPrice);
		
		JLabel lblQuantity = new JLabel("Quantity");
		lblQuantity.setFont(new Font("Agency FB", Font.BOLD, 24));
		lblQuantity.setBounds(117, 348, 77, 42);
		...
		cbCategory.setModel(new DefaultComboBoxModel(new String[] {"SUB-OHM TANK", "RDA", "RTA","RDTA"}));
		cbCategory.setBounds(220, 171, 240, 41);
		getContentPane().add(cbCategory);
		
		JComboBox cbCoilQty = new JComboBox();
		cbCoilQty.setFont(new Font("Agency FB", Font.PLAIN, 20));
		cbCoilQty.setModel(new DefaultComboBoxModel(new String[]  {"1", "2", "3","4","5","6"}));
		cbCoilQty.setBounds(220, 226, 240, 41);
		getContentPane().add(cbCoilQty);
		
		JComboBox cbName = new JComboBox();
		cbName.setFont(new Font("Agency FB", Font.PLAIN, 20));
		cbName.setModel(new DefaultComboBoxModel(new String[] { "KANGERTECH", "CROWN 3", "LUX TANK","TSUNAMI","VELOCY","GOVAD","GRIFFIN","GEMINI","LIMITLESS","IJOY","STEAM CRAVE","WISEMEC THEOREM"}));		
				...
				public void actionPerformed(ActionEvent e) {
					 try
						{	
					     ...
					     temp=cbCoilQty.getSelectedItem().toString();
					     double coil_qty=Double.parseDouble(temp);
